...
TECHS = [
	...
	TechCounter('React', r'^react(.?js)?([- ]?(?!native)\w+)?$', 'Frameworks/CMS'),
	TechCounter('Node', r'^node(.?js)?$', 'Frameworks/CMS'),
	TechCounter('Spring', r'^spring([- ]?mvc)?([- ]?framework)?$', 'Frameworks/CMS'),
	TechCounter('Angular', r'^angular(.?js)?([- ]?framework)?', 'Frameworks/CMS'),
	TechCounter('Rails', r'^(ruby[- ]?on[- ]?)?rails([- ]?framework)?', 'Frameworks/CMS'),
	TechCounter('Django', r'^django([- ]?(?!rest)\w+)?([- ]?framework)?$', 'Frameworks/CMS'),
	...
	TechCounter('Symfony', r'^symfony([- ]?framework)?', 'Frameworks/CMS'),
	...
	TechCounter('Google Cloud', r'^google[- ]?cloud', 'Platforms/Web Services'),
	...
	TechCounter('Redux', r'^(\w+[- ]?)?redux$', 'Libraries/Tools'),
	...
	TechCounter('QT', r'^(\w[- ]?)?qt([- ]?\d)?$', 'Libraries/Tools'),
	...
	TechCounter('Security', r'^(\w+)?[- ]?security$', 'Concepts/Skills'),
	TechCounter('API ', r'^api([- ]\w+)?$', 'Concepts/Skills'),
	...
	TechCounter('Test Automation', r'^test[- ]?automation$|^automated[- ]?test', 'Concepts/Skills'),
	...
	TechCounter('Database', r'^database$', 'Concepts/Skills'),
	...
	TechCounter('Architecture', r'^architecture$', 'Concepts/Skills'),
