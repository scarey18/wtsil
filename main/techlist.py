...
def new_tech_list():
	return [
		...
		TechCounter('Angular', r'^(.+?(?!&|;)\W)?angular(.?js)?\d?([- ]?framework)?((?!&|;)\W.+?)?$', 'Frameworks/CMS'),
		...
		TechCounter('Django Rest Framework', r'^(.+?(?!&|;)\W)?drf((?!&|;)\W.+?)?$|^(.+?(?!&|;)\W)?django[- ]?rest[- ]?framework((?!&|;)\W.+?)?$', 'Frameworks/CMS'),
		...
		TechCounter('Test Automation', r'^(.+?(?!&|;)\W)?test[- ]?automation((?!&|;)\W.+?)?$|^(.+?(?!&|;)\W)?automated[- ]?tests?((?!&|;)\W.+?)?$', 'Concepts/Skills'),
		...
		TechCounter('Microservices', r'^(.+?(?!&|;)\W)?micro[- ]?services?((?!&|;)\W.+?)?$', 'Concepts/Skills'),
